...
def get_cookie():
    ...
    driver = webdriver.Chrome('请替换成您的浏览器驱动路径/chromedriver.exe',chrome_options=option)
...
def sign_in(global_cookie):
    ...
    body={"signInstanceWid":signInstanceWid,"longitude":113.058109,"latitude":23.1303438200,"isMalposition":1,"abnormalReason":" ","signPhotoUrl":"","position":"广东省广州市荔湾区中山八路29号"}
